...
export default function CartPage() {
  ...
  const handleRemoveItem = (id: number, title: string) => {
    ...
    toast({
      ...
      description: `${title} ${
        language === "az" ? "səbətdən silindi" : "has been removed from cart"
      }`,
    });
  };
  ...
  const handleClearCart = () => {
    ...
    toast({
      ...
      description:
        language === "az"
          ? "Bütün məhsullar səbətdən silindi"
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm sticky top-24">
                  <CardHeader>
                    <CardTitle>
                      {language === "az" ? "Sifariş xülasəsi" : "Order Summary"}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span>
                          {language === "az" ? "Ara cəm:" : "Subtotal:"}
                        </span>
                        <span>{subtotal.toFixed(2)} ₼</span>
                      </div>
                      <div className="flex justify-between">
                        <span>
                          {language === "az" ? "Çatdırılma:" : "Shipping:"}
                        </span>
                        <span>
                          {shipping === 0
                            ? language === "az"
